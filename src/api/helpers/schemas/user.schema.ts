  ...
  body: object({
    userData: object({
      ...
      password: string({
        ...
        .regex(/[A-Z]/, "Password must contain at least one or more uppercase letters")
        .regex(/[a-z]/, "Password must contain at least one or more lowercase letters")
        .regex(/[0-9]/, "Password must contain at least one or more numbers")
        .regex(/[\W_]/, "Password must contain at least one or more special characters"),

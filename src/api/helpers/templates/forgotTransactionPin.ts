import { ForgotTransactionPinData } from "@/interfaces/email.interface";

export const forgotTransactionPin = (data: ForgotTransactionPinData) => {
          ...
          <tr>
            <td>
              <h1 style="color: #000; font-size: 24px; text-align: center; margin: 0;">
                Hello ${data.firstName}, reset your password.
              </h1>
              ...
              <p style="font-size: 12px; line-height: 24px; margin: 16px 0; color: #666;">
                ...
                <a href=${data.otp} target="_blank" style="color: #2563eb; text-decoration: none;">
                  ${data.otp}
                </a>
              </p>
              <p style="font-size: 12px; line-height: 24px; margin: 16px 0; color: #666;">
                This message was sent to ${data.firstName}. If you have questions or complaints, please contact us.
              </p>
            </td>
          </tr>
        </table>
